...
public class Diagnosa extends Konsultasi implements KonsultasiInterface {

    public Diagnosa(int idKonsul, Date tanggal, String idPengguna, String kodeDiagnosa) {
